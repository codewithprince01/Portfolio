  ...
  return (
    <div className="bg-black text-white min-h-screen relative overflow-hidden">
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        <motion.h2
          className="text-2xl md:text-4xl mt-4 md:mt-0 z-10 text-gray-300"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <section
  id="about"
  className="py-12 lg:px-6 m-4 bg-black flex flex-col-reverse md:flex-row items-center justify-center relative"
>
  <motion.div
  ...
  {/* Content comes first, followed by image below */}
  <motion.div
    ...
    transition={{ duration: 1 }}
  >
    <h2 className="text-3xl md:text-5xl text-center font-bold text-purple-500 mb-4 md:mb-8">
  ...
  <motion.img
    src="images/human_icon.svg"
    alt="Human working on laptop"
    className="w-64 md:w-80 mt-12 md:mt-0 z-10"
    initial={{ opacity: 0, x: 50 }}
    whileInView={{ opacity: 1, x: 0 }}
    transition={{ duration: 1 }}
  />
      ...
      {/* Footer Section for Social Links */}
      <div className="bg-black text-white flex flex-col items-center py-12 px-4">
        ...
        <div className="flex space-x-6">
          ...
          {/* Uncomment to enable Twitter link */}
          {/* <a
